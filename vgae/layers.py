...
from vgae.initializations import weight_variable_glorot
...
class exp_rec(Layer):
    def __init__(self, exp, n_features, normalize=False, dropout=0., **kwargs):
        super().__init__(**kwargs)
        self.dropout = dropout
        self.exp = tf.convert_to_tensor(exp, dtype=tf.int32)
        self.normalize = normalize
